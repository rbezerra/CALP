...
angular.module('myApp.controllers', ['firebase.utils', 'simpleLogin'])
  ...
  .controller('MainController', ['$route', '$scope', 'fbutil', 'simpleLogin', '$location', function($route, $scope, fbutil, simpleLogin, $location){
     $scope.dias = fbutil.syncObject('dias');
     function init() {
        simpleLogin.getUser().then(function(user) {
          if(user){
            $scope.usuario = fbutil.syncObject(['users', user.uid]);
          }else{
            $scope.usuario = null;
          }
        });
  ...
  .controller('LoginController', ['$scope', 'simpleLogin', '$location', 'fbutil', '$route', function($scope, simpleLogin, $location, fbutil, $route){
    $scope.email = null;
    $scope.pass = null;
    $scope.confirm = null;
